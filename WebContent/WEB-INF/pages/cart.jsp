...
<script type="text/javascript">
	$(function() {
		...
		//ajax 修改单个商品的数量
		//1. 获取页面中所有的 text，并为其添加 onchange 响应函数，弹出确认对话框：确认修改？
		$(":text").change(function() {
			...
			//2. 请求地址为：bookservlet
			var url = "bookServlet";
			//3. 请求参数为：method:updateItemQuantity, id:name属性值, quantity:val, time:new data()
		...
		<table cellpadding="10">
			...
			<c:forEach items="${sessionScope.ShoppingCart.items }" var="item">
				<tr>
					...
					<td><input class="${item.quantity }" type="text" size="1" name="${item.book.id }"
			...
			<tr>
				<td colspan="4"><a
					...
					&nbsp;&nbsp; <a href="bookServlet?method=forWardPage&page=cash">结账</a> &nbsp;&nbsp;</td>
			</tr>
		</table>
